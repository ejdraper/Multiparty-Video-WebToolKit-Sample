# Real time video communication application (Multiparty) using EnableX platform (Only Client End Application)
...
Alternatively, you can clone repository `git clone https://github.com/EnableX/Video-Conferencing-Open-Source-Web-Application-Sample --recursive` if you want to have both `Application Server` and `Client Application` in a single repository.
